...
ActiveRecord::Schema.define(version: 2020_11_20_072804) do
  ...
  create_table "file_elements", force: :cascade do |t|
    t.bigint "observation_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["observation_id"], name: "index_file_elements_on_observation_id"
  end
  ...
  add_foreign_key "file_elements", "observations"
end
